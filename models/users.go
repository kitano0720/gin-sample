...
type User struct {
	...
	UserName  string    `form:"user_name" boil:"user_name" json:"user_name" toml:"user_name" yaml:"user_name"`
	Age       int       `form:"age" boil:"age" json:"age" toml:"age" yaml:"age"`
	CreatedAt null.Time `form:"created_at" boil:"created_at" json:"created_at,omitempty" toml:"created_at" yaml:"created_at,omitempty"`
	UpdatedAt null.Time `form:"updated_at" boil:"updated_at" json:"updated_at,omitempty" toml:"updated_at" yaml:"updated_at,omitempty"`
...
var (
	userAllColumns            = []string{"user_id", "user_name", "age", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"user_name", "age", "created_at", "updated_at"}
